...
//-----------------------------------------------------------------------------
class CWeaponFrag: public CWeaponCoopBaseHLCombat
{
	DECLARE_CLASS( CWeaponFrag, CWeaponCoopBaseHLCombat );
public:
...
void DropPrimedFragGrenade( CBasePlayer *pPlayer, CBaseCombatWeapon *pGrenade )
{
