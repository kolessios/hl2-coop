...
//================================================================================
// Crea una entidad temporal que transfiere el evento
// de animación a reproducir sobre un jugador
//================================================================================
...
#ifndef CLIENT_DLL
extern void SendPlayerAnimation( CBasePlayer *pPlayer, PlayerAnimEvent_t pEvent, int nData );
#endif
