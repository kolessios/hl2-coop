...
//HL2MP
    ...
    REGISTER_SHARED_ACTIVITY( ACT_SYNERGY_IDLE );
    REGISTER_SHARED_ACTIVITY( ACT_SYNERGY_RUN );
    REGISTER_SHARED_ACTIVITY( ACT_SYNERGY_IDLE_CROUCH );
    REGISTER_SHARED_ACTIVITY( ACT_SYNERGY_RUN_CROUCH );
    REGISTER_SHARED_ACTIVITY( ACT_SYNERGY_GESTURE_GIVE_ITEM );
