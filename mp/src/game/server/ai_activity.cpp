...
//===========================
    ...
    ADD_ACTIVITY_TO_SR( ACT_SYNERGY_IDLE );
    ADD_ACTIVITY_TO_SR( ACT_SYNERGY_RUN );
    ADD_ACTIVITY_TO_SR( ACT_SYNERGY_IDLE_CROUCH );
    ADD_ACTIVITY_TO_SR( ACT_SYNERGY_RUN_CROUCH );
    ADD_ACTIVITY_TO_SR( ACT_SYNERGY_GESTURE_GIVE_ITEM );
}
